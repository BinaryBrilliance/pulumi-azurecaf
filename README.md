...
```bash
wget https://github.com/BinaryBrilliance/azurecaf/releases/download/v0.0.0/pulumi-resource-azurecaf-v0.0.0-linux-amd64.tar.gz
tar xfv pulumi-resource-azurecar-v0.0.0-linux-amd64.tar.gz
