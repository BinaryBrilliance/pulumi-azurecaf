...
namespace BinaryBrilliance.Azurecaf
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("BinaryBrilliance.Azurecaf.version.txt");
    ...
    internal sealed class AzurecafResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public AzurecafResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
